...
<b class="col-md-4" style="color:#686868;">О полном наименовании образовательной организации</b>
...
<!-- Вторая форма ввода -->
<div class="row" style="margin-top:20px;border-bottom:2px solid #d7c97c;">
    <b class="col-md-4" style="color:#686868;">Сокращенное (при наличии) наименование образовательной организации</b>
    <div class="form col-md-8">
...
<!-- Третья форма ввода -->
<div class="row" style="margin-top:20px;border-bottom:2px solid #d7c97c;">
    <b class="col-md-4" style="color:#686868;">Дата создания образовательной организации</b>
    <div class="form col-md-8">
