    ...
    if (isset($dataform)) {
        foreach ($query1 as $number => $name) {
            ...
            <div class="row scriprow" id="<?php echo $name['iddataforms']; ?>" value="<?php echo $number ?>">
                ...
                <div class="col-sm-2"><textarea class="form-control" name="Massrows[<?php echo $number ?>][0][]"
                ...
                <div class="col-sm-3 idsaytaddress" id="address">
                        ...
                        foreach ($tableemail as $row1) {
                            if ($name['iddataforms'] == $row1['iddataforms']) {
                                ...
                                <div class="row textsaytaddres" value="<?php echo $row1['iddataforms'] ?>">
                                    ...
                                    <?php echo Html::a('X', ['/deleteform2', 'post' => $row1['idform2email'], 'what_to_delete' => 'email'], ['id' => 'remove_address', 'class' => 'btn btn-danger col-sm-2']) ?>
                                </div>
                            <?php }
                        }
                    } ?>
                ...
                <div class="col-sm-2 idsaytaddress" id="sayt">
                        ...
                        foreach ($tableaddres as $row2) {
                            if ($name['iddataforms'] == $row2['iddataforms']) { ?>
                                <div class="row textsaytaddres" value="<?php echo $row2['iddataforms'] ?>">
                                    ...
                                    <?php echo Html::a('X', ['/deleteform2', 'post' => $row2['idform2addres'], 'what_to_delete' => 'address'], ['id' => 'remove_address', 'class' => 'btn btn-danger col-sm-2']) ?>
                                </div>
                            <?php }
                        }
                    } ?>
