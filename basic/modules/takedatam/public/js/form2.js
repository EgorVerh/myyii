$(document).ready(function(){
    ...
    $("#add_row").click(function(){
        ...
        if (typeof $('#div_add_row').prev().attr("value") !== 'undefined')
        {
            ...
            $("#div_add_row").before('<div class="row scriprow" id="0" value='+k+'><div class="col-sm-1 style_col_sm_1"><ul><li><button type="button" id="btn_up" class="btn scripbtn">^</button></li><li><button type="button" id="btn_down" class="btn scripbtn">v</button></li><li><button type="button" id="remove_row" class="btn btn-danger">X</button></li></ul></div><input type="hidden" name="id[]" value="0"><div class="col-sm-2 style_col_sm_2"><textarea class="form-control" id="Textarea1" name="Massrows['+k+'][0][]"></textarea></div><div class="col-sm-2 style_col_sm_2"><textarea class="form-control" id="Textarea2" name="Massrows['+k+'][0][]"></textarea></div><div class="col-sm-2 style_col_sm_2"><textarea class="form-control" id="Textarea3" name="Massrows['+k+'][0][]"></textarea></div><div class="col-sm-3 idsaytaddress" id="address"><button type="button" id="add_address" class="btn btn-success" name="'+k+'">+ Добавить</button></div><div class="col-sm-2 style_col_sm_2 idsaytaddress" id="sayt"><button type="button" id="add_sayt" class="btn btn-success" name="'+k+'">+ Добавить</button></div></div>');
        }
        else
        {
            $("#div_add_row").before('<div class="row scriprow" id="0" value="0"><div class="col-sm-1 style_col_sm_1"><ul><li><button type="button" id="btn_up" class="btn scripbtn">^</button></li><li><button type="button" id="btn_down" class="btn scripbtn">v</button></li><li><button type="button" id="remove_row" class="btn btn-danger">X</button></li></ul></div><input type="hidden" name="id[]" value="0"><div class="col-sm-2 style_col_sm_2"><textarea class="form-control" id="Textarea1" name="Massrows[0][0][]"></textarea></div><div class="col-sm-2 style_col_sm_2"><textarea class="form-control" id="Textarea2" name="Massrows[0][0][]"></textarea></div><div class="col-sm-2 style_col_sm_2"><textarea class="form-control" id="Textarea3" name="Massrows[0][0][]"></textarea></div><div class="col-sm-3 style_col_sm_3 idsaytaddress" id="address"><button type="button" id="add_address" class="btn btn-success" name="0">+ Добавить</button></div><div class="col-sm-2 style_col_sm_2 idsaytaddress" id="sayt"><button type="button" id="add_sayt" class="btn btn-success" name="0">+ Добавить</button></div></div>');
        }
    ...
    $(document).on('click','#add_address',function(){
        ...
        if (typeof $(this).prev().attr("value") !== 'undefined')
        {
            ...
            $(this).before('<div class="row textsaytaddres"  value='+k+'><div class="col-sm-10"><textarea class="form-control" id="textaddres'+k+'"name="Massrows['+numberrow+'][1][]"></textarea></div><button type="button" id="remove_address" class="btn btn-danger col-sm-2 style_col_sm_2">X</button></div>');
        }
        else
        {
            $(this).before('<div class="row textsaytaddres" value='+i+'><div class="col-sm-10"><textarea class="form-control" id="textaddres'+i+'"  name="Massrows['+numberrow+'][1][]"></textarea></div><button type="button" id="remove_address" class="btn btn-danger col-sm-2 style_col_sm_2">X</button></div>');
        }
    })
    ...
    $(document).on('click','#add_sayt',function(){
        ...
        {
            k=Number($(this).prev().attr("value"))+1;
            $(this).before('<div class="row textsaytaddres" value='+k+'><div class="col-sm-10"><textarea class="form-control" id="textsayt'+k+'" name="Massrows['+numberrow+'][2][]"></textarea></div><button type="button" id="remove_address" class="btn btn-danger col-sm-2 style_col_sm_2">X</button></div>');
        }
        else
        {
            $(this).before('<div class="row textsaytaddres" value='+i+'><div class="col-sm-10"><textarea class="form-control" id="textsayt'+i+'" name="Massrows['+numberrow+'][2][]"></textarea></div><button type="button" id="remove_address" class="btn btn-danger col-sm-2 style_col_sm_2">X</button></div>');
        }   
    })
